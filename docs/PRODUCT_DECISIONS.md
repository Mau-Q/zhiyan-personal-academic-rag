...
| PD-025 | ACCEPTED | 阶段 0 冻结单用户个人库的 500 篇标称/1000 篇验证上界、0.2 QPS、问答并发 2、入库并发 1、单台既有主机预算及后续 SLO 目标 | 范围/资源/SLO 子门禁完成；冻结值是待验证目标，不冒充目标规模性能、真实 LLM 延迟或 PostgreSQL 生命周期已达标；阶段 0 仍需冻结数据身份与生命周期语义 |
