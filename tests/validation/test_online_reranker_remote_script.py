...
class OnlineRerankerRemoteScriptTests(unittest.TestCase):
    ...
    def test_summary_is_sanitized_and_lifecycle_closed(self) -> None:
        for field in (
            ...
            "ready_postgres_lookup_latency_ms_p95",
            "ready_physical_verification_wall_latency_ms_p95",
            "ready_elasticsearch_verification_work_latency_ms_p95",
            "ready_milvus_verification_work_latency_ms_p95",
